...
@interface XMPPStream : NSObject <XMPPTransportDelegate, GCDAsyncSocketDelegate, SRWebSocketDelegate>
...
- (void)xmppStream:(XMPPStream *)sender webSocketDidConnect:(SRWebSocket *)websocket;

- (void)xmppStream:(XMPPStream *)sender transportDidConnect:(id<XMPPTransportProtocol>)aTransport;
